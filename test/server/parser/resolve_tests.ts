...
import { IndexedObjectFields, ResolveFailure } from '../../../compiler/lexical-analysis/ast';
...
const isResolvedSpec = <T1 extends ast.Node | IndexedObjectFields>(spec): spec is ResolvedSpec<T1> => {
...
const isFailedResolvedSpec = <T1 extends ResolveFailure>(spec): spec is FailedResolvedSpec<T1> => {
